...
31. Em uma janela anônima, entrar marcando `Lembrar de mim`, fechar a aba e acessar novamente `/dashboard`. Confirmar que a sessão é restaurada sem novo login; o preenchimento automático de senha, quando houver, é responsabilidade do navegador/gerenciador de senhas.
