...
3. Abrir a vitrine publica em `/anuncios` e confirmar filtros, imagem de capa e detalhe.
4. Enviar contato pelo detalhe do anuncio e verificar o log/e-mail configurado.
5. Entrar com outro usuario e confirmar que ele nao acessa nem altera anuncios do primeiro usuario.
